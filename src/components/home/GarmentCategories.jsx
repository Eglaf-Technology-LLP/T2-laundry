        ...
        {cats.map((c) => {
          ...
          return (
            <Link
              key={c.id}
              to="/services"
              className="group relative overflow-hidden rounded-3xl steam-glass p-7 shadow-sm hover:shadow-xl hover:shadow-navy/5 transition-all duration-500 hover:-translate-y-1"
            >
